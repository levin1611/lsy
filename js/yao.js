...
YAO.Carousel = function(oConfig){
	...
	//alert(this.lnkBtnPrevious.href)
	this.init();
};
...
YAO.YAlbum.prototype.IMG_BTN_PREVIOUS = '';
YAO.YAlbum.prototype.IMG_BTN_NEXT = '';
YAO.YAlbum.prototype.SHARDOW_ID = 'carousel_photo_shardow';
YAO.YAlbum.prototype.LOAD_IMG_PATH = 'loading.gif';
YAO.YAlbum.prototype.LOAD_IMG_ID = 'carousel_photo_loading';

YAO.YAlbum.prototype.init = function(){
	var oSelf = this, i;
	var aIndex = oSelf.oSamples[oSelf.lastIndex+1] ? oSelf.lastIndex+1 :oSelf.lastIndex;   //解决当只有一张图片是点击会跳转的问题
	...
	this.btnNext = YAO.Builder.Node('a', {
		href: oSelf.oSamples[aIndex].href ,                 //解决当只有一张图片是点击会跳转的问题
